...
<div class="col-md-12">
    ...
    <div class="panel panel-primary">
        <div class="panel-heading" style="color: #fff; background-color: #337ab7; border-color: #337ab7; padding: 10px 15px; border-bottom: 1px solid transparent; border-top-left-radius: 3px; border-top-right-radius: 3px;">List product</div>
               ...
               <?php foreach($data as $rows): ?>
                <tr>
                    <td style="text-align:center;">
                        <?php if(file_exists("../asset/img/".$rows->photo)&&$rows->photo != ""): ?>
                            <img src="../asset/img/<?php echo $rows->photo; ?>" style="width:100px;">
                        <?php endif; ?> 
                    </td>
                    <td><?php echo $rows->name; ?></td>
                    <td style="text-align:left;">
                            <?php 
                                //trong view có thể truy vấn trực tiếp csdl
                                //lấy biến kết nối
                                $conn = Connection::getInstance();
                                $query = $conn->query("select name from categories where id = ".$rows->category_id);
                                //lấy một kết quả trả về
